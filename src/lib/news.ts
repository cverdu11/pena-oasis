...
export const FEATURED_NEWS = {
  ...
  summary:
    "La Federación aprobó la entrada de Oasis junto a otras cuatro agrupaciones; ya son 39 las peñas federadas.",
  category: "Actualidad",
  author: "Marina Rivas",
  ...
  originalUrl:
    "https://www.diariosur.es/malagacf/federacion-penas-malaguistas-suma-cinco-nuevas-agrupaciones-20260706111622-nt.html",
  paragraphs: [
